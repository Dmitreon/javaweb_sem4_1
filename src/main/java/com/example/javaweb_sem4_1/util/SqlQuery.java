...
public final class SqlQuery {
    public static final String INSERT_USER = "INSERT INTO users (username, password, email, predefined_image_id) VALUES (?, ?, ?, ?)";
    public static final String SELECT_ALL_USERS = "SELECT id, username, password, email, predefined_image_id FROM users ORDER BY id";
    public static final String UPDATE_USER = "UPDATE users SET username = ?, password = ?, email = ?, predefined_image_id = ? WHERE id = ?";
    public static final String SELECT_USER_BY_FIELD = "SELECT id, username, password, email, predefined_image_id FROM users WHERE %s = ?";
